...
const song: Song = {
  ...
  lyrics: [
    ...
    {
      time: "0:28",
      original: "優等生無知なフリして踊っちゃって",
      pronunciation: "유우토오세이 무치나 후리시테 오돗챳테",
    ...
    {
      time: "0:35",
      original: "もう譲渡見せびらかし合いましょ劣等感妄",
      pronunciation: "모오 죠오토 미세비라카시 아이마쇼 렛토오칸보오",
    ...
    {
      time: "1:29",
      original: "帰ってすぐに水やり 人間の営み",
      pronunciation: "카엣테 스구니 미즈야리 닝겐노 이토나미",
    ...
    {
      time: "2:48.3",
      original: "戦わないと撫でてもらえない",
      pronunciation: "타타카와 나이토 나데테 모라에나이",
    ...
    },
    {
      ...
      translation:
        "척수 반사의 눈물샘은 말라비틀어진 뇌로 노래할 수 있어 감격입니다",
      cheer: {
        text: "",
        tag: "swing",
      },
