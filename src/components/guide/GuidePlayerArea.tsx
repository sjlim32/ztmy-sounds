...
import { PlayerControls } from "@/components/guide/PlayerControls";
...
export function GuidePlayerArea() {
  ...
  return (
    <div
      ...
      className={`fixed inset-0 flex flex-col items-center justify-center pl-6 pr-108 transition-opacity duration-500 ${
